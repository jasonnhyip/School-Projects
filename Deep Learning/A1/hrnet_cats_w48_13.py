...
optimizer = dict(
    type='NAdam', # You may choose other optimizers
...
model = dict(
    ...
    'top_down/hrnet/hrnet_w48_coco_256x192-b9e0b3ab_20200708.pth',
    # pretrained='https://download.openmmlab.com/mmpose/'
    # 'pretrain_models/hrnet_w48-8ef0771d.pth', # This is an ImageNet-pretrained model
    backbone=dict(
        type='HRNet',
        in_channels=3,
        extra=dict(
